...
export class BookService {
  ...
  createComment(comment: any): Observable<any> {
    return this.httpClient.post<any>(
      this.apiServerUrl + "/api/comments",
      comment
    );
  }
  updateBook(book: Book): Observable<Book> {
    return this.httpClient.put<Book>(
      this.apiServerUrl + "/api/books/update",
      book
    );
  }
  updateComment(comment: any): Observable<any> {
    return this.httpClient.put<any>(
      this.apiServerUrl + "/api/books/update/" + comment.id,
      comment
    );
  }
  ...
  getHistoryByUser(user: any): Observable<any> {
    return this.httpClient.get<any>(
      this.apiServerUrl + "/api/books/history/" + user
    );
  }
  getDiscussionByBook(book: any): Observable<any> {
    return this.httpClient.get<any>(
      this.apiServerUrl + "/api/comments/get/" + book.id
    );
  }

  borrowBook(book: any): Observable<any> {
    return this.httpClient.put<any>(
      this.apiServerUrl + "/api/books/borrow/" + book.id,
      book
    );
  }
  ...
  issueBook(book: Book): Observable<Book> {
    return this.httpClient.put<any>(
      this.apiServerUrl + "/api/books/issue/" + book.id,
      book
    );
  }
  ...
  returnBook(book: Book): Observable<Book> {
    return this.httpClient.put<Book>(
      this.apiServerUrl + "/api/books/return/" + book.id,
      book
    );
  }
  ...
  deleteComment(id: number): Observable<any> {
    return this.httpClient.delete<any>(
      this.apiServerUrl + "/api/comments/" + id
    );
  }

  filterByParent(categoryId: number): Observable<any> {
    return this.httpClient.get(
      this.apiServerUrl + "/api/books/filter-by-category/" + categoryId
    );
  }
  filterCommentsByReferencedId(referencedCommentId: number): Observable<any> {
    return this.httpClient.get(
      this.apiServerUrl +
        "/api/comments/filter-by-referenceId/" +
        referencedCommentId
    );
  }
  searchBooks(text?: string): Observable<any> {
    return this.httpClient.get(
      this.apiServerUrl + "/api/books/search?text=" + text
    );
  }
}
